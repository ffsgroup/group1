...
@WebServlet("/TaskReportFor")
public class TaskReportFor extends HttpServlet {

    private static final long serialVersionUID = 1L;

    public TaskReportFor() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String reportPeople = request.getParameter("reportPeople");
        System.out.println("TaskReportFor " + reportPeople);
        try {
            task = TaskUtils.getReportFor(conn, loginedUser, reportFor, reportPeople);
