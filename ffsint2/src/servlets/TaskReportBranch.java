...
@WebServlet("/TaskReportBranch")
public class TaskReportBranch extends HttpServlet {

    private static final long serialVersionUID = 1L;

    public TaskReportBranch() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String reportBranch = request.getParameter("reportBranch");
        System.out.println("TaskReportBranch " + reportBranch);
        try {
            task = TaskUtils.getReportBranch(conn, loginedUser, reportFor, reportBranch);
