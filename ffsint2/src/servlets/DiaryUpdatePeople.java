...
public class DiaryUpdatePeople extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      System.out.println("User " + userName + " update people"  );           
        ...
        if(ServletFileUpload.isMultipartContent(request)){
            try {
                ...
                for(FileItem item : multiparts){
                 ...
                 System.out.println("username " + userName + " from " + fromuser);
                 System.out.println("username " + userName + " user1 " + duser1);
 DBUtils.SavePeople(conn, tranid, userName, duser1, duser2, duser3, duser4, duser5, duser6, duser7, duser8, duser9, duser10, resp1, resp2, resp3, resp4, resp5, resp6, resp7, resp8, resp9, resp10, fromuser);
